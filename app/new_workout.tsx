...
const NewWorkout = () => {
    const date = useNewWorkoutStore((state) => state.date);
    const setDate = useNewWorkoutStore((state) => state.setDate);
    const tagColor = useNewWorkoutStore((state) => state.tagColor);
            ...
            <SafeAreaView className="flex-1" edges={["top"]}>
                ...
                >
                    ...
                    >
                        ...
                        <NoteBlock value={notes} setter={setNewNotes} />
