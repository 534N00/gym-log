...
// Note: could get rid of this if I instead just loaded workouts from DB directly using StatelessExerciseTiles
// but also if I keep it like this I can later add mutability to past workouts.
/**
 * Zustand store for storing state of past workouts
 */
    ...
    return {
        ...
        setPastWorkout: (workout_data) => {
            ...
            for (const exercise of workout_data.exercises as CompleteExercise[]) {
                ...
                const setsCPY: Record<string, SetState> = {},
                    setOrderCPY: string[] = [];
                let setId: string;
